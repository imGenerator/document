# Nodejs中的事件循环机制理解?
 ...
 ![](https://proxywzh.gitee.io/static/node/3.png)
...
而在`NodeJS`中，事件循环是基于`libuv`实现，`libuv`是一个多平台的专注于异步IO的库，如下图最右侧所示：
 ...
 ![](https://proxywzh.gitee.io/static/node/4.png)
...
上节讲到事件循环分成了六个阶段，对应如下：
 ...
 ![](https://proxywzh.gitee.io/static/node/5.png)
...
流程图如下所示：
 ...
 ![](https://proxywzh.gitee.io/static/node/6.png)
